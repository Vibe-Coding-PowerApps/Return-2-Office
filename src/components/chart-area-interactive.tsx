...
export function ChartAreaInteractive() {
  ...
  const { filteredData, domain } = React.useMemo(() => {
    ...
    if (timeRange === "30d") {
      daysToSubtract = 29 // For 30 days inclusive (last 30 days)
    ...
    <Card className="@container/card dark:bg-zinc-900/50">
      <CardHeader>
        <div className="space-y-1.5">
          <CardTitle>Total Office Occupancy</CardTitle>
          <CardDescription>
            <span className="hidden @[540px]/card:block">
              {timeRange === "90d" && "Average daily occupancy for the last 3 months"}
              {timeRange === "30d" && "Average daily occupancy for the last 30 days"}
              {timeRange === "7d" && "Average daily occupancy for the last 7 days"}
            </span>
